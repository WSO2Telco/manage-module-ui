...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__commons_services_quotacap_service__ = __webpack_require__("../../../../../src/app/commons/services/quotacap.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__commons_services_message_service__ = __webpack_require__("../../../../../src/app/commons/services/message.service.ts");
...
var QuotaCapMainComponent = (function () {
    function QuotaCapMainComponent(reportingService, quotaService, message, authService) {
     ...
     * @param event
     */
    QuotaCapMainComponent.prototype.onSubscriberSelected = function (val) {
        this.subscriber = val;
        this.app = '';
        this.api = '';
        this.appID = '';
     ...
     * @param event
     */
    QuotaCapMainComponent.prototype.onOperatorSelected = function (val) {
        this.selectedoperator = val;
        this.clearErrors();
        for (var _i = 0, _a = this.operatorsList; _i < _a.length; _i++) {
            var entry = _a[_i];
            if (entry == this.selectedoperator) {
                if (this.isSubscriberSelect) {
                    this.getQuotaofSubscriber(this.subscriber);
                }
                else if (this.isAppSelect) {
    ...
    QuotaCapMainComponent.prototype.getAppsofSubscriber = function (subscriberID) {
        var _this = this;
        this.clearErrors();
        this.quotaService.getApps(subscriberID, function (response) {
            _this.applicationList = response;
            var count = 0;
            for (var _i = 0, _a = _this.applicationList; _i < _a.length; _i++) {
                var entry = _a[_i];
                var splitted = entry.split(':', 2);
                _this.applications[count] = new __WEBPACK_IMPORTED_MODULE_4__commons_models_common_data_models__["d" /* Application */];
    ...
    QuotaCapMainComponent.prototype.getQuotaofSubscriber = function (subscriberID) {
        ...
        this.clearErrors();
        this.quotalist = [];
        this.quotaService.getQuotaLimitInfo(subscriberID, this.selectedoperator, function (response) {
            if (response.Success.text.length != 0) {
                var count = response.Success.text.length;
                for (var i = 0; i < count; i++) {
                    _this.quotalist[i] = new __WEBPACK_IMPORTED_MODULE_4__commons_models_common_data_models__["f" /* QuotaList */]();
    ...
    QuotaCapMainComponent.prototype.getQuotaofApp = function (appID) {
        ...
        this.clearErrors();
        this.quotalist = [];
        this.quotaService.getQuotaLimitInfoApp(appID, this.selectedoperator, function (response) {
            if (response.Success.text.length != 0) {
                var count = response.Success.text.length;
                for (var i = 0; i < count; i++) {
                    _this.quotalist[i] = new __WEBPACK_IMPORTED_MODULE_4__commons_models_common_data_models__["f" /* QuotaList */]();
    ...
    QuotaCapMainComponent.prototype.getQuotaofApi = function (apiID) {
        ...
        this.clearErrors();
        this.quotalist = [];
        this.quotaService.getQuotaLimitInfoApi(apiID, this.selectedoperator, function (response) {
            if (response.Success.text.length != 0) {
                var count = response.Success.text.length;
                for (var i = 0; i < count; i++) {
                    _this.quotalist[i] = new __WEBPACK_IMPORTED_MODULE_4__commons_models_common_data_models__["f" /* QuotaList */]();
     ...
     * @param event
     */
    QuotaCapMainComponent.prototype.onAppSelected = function (val) {
        this.api = '';
        this.appID = '';
        this.app = val;
        this.SetQuotaResultLabel();
        ...
        if (id.length != 0) {
            this.quotaService.getApis(id, function (response) {
                ...
                for (var _i = 0, _a = _this.apiList; _i < _a.length; _i++) {
                    ...
                    _this.apis[count] = new __WEBPACK_IMPORTED_MODULE_4__commons_models_common_data_models__["e" /* Api */];
    ...
    QuotaCapMainComponent.prototype.quotaInputValuechange = function (val) {
    ...
    QuotaCapMainComponent.prototype.onquotacapFormSubmit = function (quotacapForm) {
        ...
        if (!this.isEmpty() && this.subscriber.length != 0 && !this.is_invalid_period && this.subscriber.length != 0
            ...
            this.quotaService.addNewQuotaLimit(this.subscriber, this.appID, this.api, this.selectedoperator, this.quotaInputValue, this.fromdate, this.todate, function (errorMsg) {
     ...
     * @param event
     */
    QuotaCapMainComponent.prototype.onApiSelected = function (val) {
        this.api = val;
        this.SetQuotaResultLabel();
        for (var _i = 0, _a = this.applicationList; _i < _a.length; _i++) {
            var entry = _a[_i];
    ...
    QuotaCapMainComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__data_providers_reporting_remote_data_service__["a" /* ReportingRemoteDataService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__data_providers_reporting_remote_data_service__["a" /* ReportingRemoteDataService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__commons_services_quotacap_service__["a" /* QuotaService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__commons_services_quotacap_service__["a" /* QuotaService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_5__commons_services_message_service__["a" /* MessageService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__commons_services_message_service__["a" /* MessageService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__commons_services_authentication_service__["a" /* AuthenticationService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__commons_services_authentication_service__["a" /* AuthenticationService */]) === 'function' && _d) || Object])
    ], QuotaCapMainComponent);
    return QuotaCapMainComponent;
    var _a, _b, _c, _d;
}());
//# sourceMappingURL=/home/manoj/WSO2TelcoProjects/WSO2TelcoNew/manage-module-ui/src/quotacap-main.component.js.map
...
//# sourceMappingURL=/home/manoj/WSO2TelcoProjects/WSO2TelcoNew/manage-module-ui/src/quotacap.module.js.map
...
//# sourceMappingURL=/home/manoj/WSO2TelcoProjects/WSO2TelcoNew/manage-module-ui/src/quotacap.routes.js.map
