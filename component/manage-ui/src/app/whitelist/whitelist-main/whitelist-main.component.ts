...
export class WhitelistMainComponent implements OnInit {
    ...
    getBlackListNumbersCount(apiid: string, appid: string, subscriber: string) {
        this.blackListWhiteListService.getBlacklistCount(appid, apiid, subscriber, 'whitelist', (response) => {
    ...
    */
    searchBlackListNumbers() {
        ...
        this.blackListWhiteListService.getBlacklistNumberExit(newappId, this.id, this.msisdn, newsp, 'whitelist', (response) => {
    ...
    /**
   *  Download whitelist number for api
   * @param AppId/APIID
   */
    downloadBlackListNumbers() {
        ...
        this.blackListWhiteListService.downloadBlacklistNumberList(this.id, newappId, newsp, 'whitelist', (response) => {
