...
const getAddSubcategoryRequest = function (params) {
...
const invokeRateWebService = function (request) {
  let deferred = Q.defer();

  let authRequestOptions = {
    rejectUnauthorized: false,
    payload: getAddSubcategoryRequest(request.payload)
  };

  wreck.post(config.rateServiceURL+'/AuthenticationAdmin', authRequestOptions, (error, res, payload) => {
    if (error) {
