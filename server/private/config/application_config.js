...
var appConfig = {
    /** the first parameter of the url http://10.10.12.31:3060/mamage
     * */
     ...
     * */
    authServerURL: process.env.wm_auth_server_url || 'https://10.10.12.31:9443/services',
    /** the url used to access the rate services
     * */
    rateServiceURL: process.env.wm_rate_service_url || 'http://10.10.12.31:9763/ratecard-service/ratecardservice/',
    /** the url used to load the app history details
     * */
    reportingUrl: process.env.wm_reporting_url || 'https://10.10.12.31:9443/workflow-service/workflow/history',
    /** the url for blacklist whitelist services
     * */
    blacklistWhitelistServiceURL: process.env.wm_blacklist_whitelist_service_url || 'http://10.10.12.31:9763/blacklist-whitelist-service/queries/',
    /** the url used for quota services
     * */
    quotaServiceUrl: process.env.wm_quota_service_url || 'http://10.10.12.31:9763/quota-service/services/',
    /** the url of the activity engine
     * */
    businessProcessEngineBaseUrl: process.env.wm_business_process_engine_url || 'http://10.10.12.31:9763/activiti-rest/service',
    /**this url is used to load the credit plan
     * */
    creditControlServiceURL: process.env.wm_credit_control_service_url || 'http://10.10.12.31:9763/credit-control-service/services/',
